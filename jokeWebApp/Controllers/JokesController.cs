...
namespace jokeWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        //arg is the "name" in the ShowSearchForm
        public async Task<IActionResult> ShowSearchResults(String SearchPhrase)

        {   // allows us to search db and return relevent results based on SearchPhrase input
            return View("Index", await _context.Joke.Where(j => j.JokeQuestion.Contains(SearchPhrase))
                         .ToListAsync());
        ...
        // GET: Jokes/Create
        [Authorize] // only allow creation of jokes if user has logged in
